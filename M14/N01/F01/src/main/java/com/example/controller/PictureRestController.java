...
public class PictureRestController {
	...
	public ResponseEntity<Picture> create(@PathVariable int id) {
		// Picture picture = new Picture("picture", 10.6, shopRepository.findById(id).get());
		
		Picture picture = new Picture("picture", 10.6);
		picture.setShop(shopRepository.findById(id).get());
