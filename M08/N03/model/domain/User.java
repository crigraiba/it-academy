...
public class User {
	...
	public String getVideosList(LocalDateTime currentDateTime) {
		...
		for (Video video : videosList) {
			...
			sb.append("\n[URL = " + video.getURL() + ", Títol = " + video.getTitle() + ", Durada = " + video.getDuration() + ", Tags = " + video.getTagsList() + ", Data i hora de pujada = " + video.getUploadDateTime() + ", Estat de pujada = " + video.getUploadStatus() + "]");
		}
