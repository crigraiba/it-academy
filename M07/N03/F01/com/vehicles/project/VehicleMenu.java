...
public class VehicleMenu {
	...
	public static String[] getVehicleParams() {
		if (choice == 1) {
			System.out.println("Es procedirà a crear una MOTO.\n");
		} else if (choice == 2) {
			System.out.println("Es procedirà a crear un COTXE.\n");
		} else if (choice == 3) {
			System.out.println("Es procedirà a crear un CAMIÓ.\n");
		}
	...
	static List<Vehicle> vehiclesRepository = new ArrayList<>();
	
	public static void addToVehiclesRepository() {
		vehiclesRepository.add(vehicle);
	}
	
	public static String printVehiclesRepositorySize() {
		return "Total de vehicles = " + vehiclesRepository.size();
	}
	
	public static String printAllVehicles() {
		StringBuilder sb = new StringBuilder();
		
		for (Vehicle vehicle : vehiclesRepository) {
			sb.append(vehicle + " " + vehicle.printVehicle(choice));
		}
