...
public class Main {
	...
	public static void main(String[] args) {
		...
		controller.createVolunteer("Juan Volunteer", "Dirección molona 6", "614266666", 0.0);

		// S'aplica un augment o reducció del salari base en funció del tipus d'empleat
		controller.payAllEmployees();
		
		// S'emet un bonus del 10% del salari brut anual a tota la plantilla excepte als empleats de tipus Volunteer
		controller.payBonus();
